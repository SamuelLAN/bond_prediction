...
top_1_dealer_pairs = top_1_dealer_pairs[:int(len(top_1_dealer_pairs) * 0.5)]
...
utils.write_json(utils.get_relative_file('runtime', 'json', 'visualize_top_0.5_dealer_pairs_reverse.json'), visualize_data)
utils.write_json(utils.get_relative_file('runtime', 'json', 'visualize_top_0.5_dealer_pairs_bundling_directed_reverse.json'), nodes2)
exit()
