...
def get_x_y_for_one_dealer(traces, dictionary, _input_windows, _output_windows, pre_traces=None,
                           _with_day_off=False, _buy_sell_plan=0, _use_volume=False):
...
# group_name = 'group_spectral_clustering_with_patterns_info_cluster_6_split_by_date.json'
...
#
# # generate save dir
# save_file_path = utils.get_relative_dir('input_data', group_name.split('.')[0], param_name, f'group_{group_index}',
